...
💻 Power BI Desktop: For data visualization and interactive dashboard creation. 📑 Microsoft Excel: For initial data cleaning and preparation. 🔢 DAX (Data Analysis Expressions): To create custom measures like Sum of AOV and Max of Profit.
...
Sum of AOV: 121.01K
📈 Sum of Profit by Month • Visual: Column Chart • Trend: Shows performance from January to December, with a significant profit peak in November.
